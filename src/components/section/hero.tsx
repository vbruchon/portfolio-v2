...
export const Hero: FC<HeroProps> = ({ content }) => (
  <>
    <section className="relative flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-28 h-[80vh]">
      ...
      <div className="lg:absolute lg:-bottom-4 text-center">
